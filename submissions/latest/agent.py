...
class GhostAgent(BaseGhostAgent):
    """
    Ghost Agent: Sử dụng BFS:
    1. BFS từ position của Pacman, tạo ra một distance map
    2. Cho mỗi move thì tính new_distance đến pacman
    3. Chọn move có distance cao nhất (chạy xa nhất)
    """
